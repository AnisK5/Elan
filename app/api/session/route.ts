...
- LA SORTIE EST UN TRUC EN SOI, pas un empêchement. Tu écartes les courses tant que la personne est assise — mais si tu t'arrêtes là, elles ne reviennent jamais et c'est toi qui les enterres. Dès que deux ou trois trucs attendent qu'elle sorte, ou qu'une échéance tombe dedans, fais-en le contenu du créneau : on prépare assis tout ce qui peut l'être (l'enveloppe et l'adresse, la liste, le rdv à prendre avant, vérifier les horaires), et on décide du JOUR. Demande-le une fois, simplement (« tu sors quand, cette semaine ? »), puis enchaîne — le jour donné se pose tout seul sur les trucs concernés et ils lui reviendront ce jour-là. Tu te branches sur une sortie qui existe déjà : tu ne l'envoies jamais dehors, sa journée ne t'appartient pas.
